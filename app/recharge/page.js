...
function PageBody(){
 ...
 async function submit(e){
  ...
  try{
   ...
   batch.set(reqRef,{uid:user.uid,profileId:profile,type,amount,status:"pending",paymentMethod:"upi",utr:clean,utrClaimId:claimRef.id,createdAt:serverTimestamp()});
